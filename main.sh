...
#sbatch FG1_conservation/1_reformat.sh $variantDir $variantFileName $variantDir ${scriptDir}FG1_conservation
#sbatch FG1_conservation/2_get_cons_features.sh $variantDir $variantFileName $variantDir ${scriptDir}FG1_conservation

# FG2: Get VEP features
#sbatch FG2_vep/1_get_vep_cache.sh ${scriptDir}FG2_vep
#sbatch  FG2_vep/2_query_vep_cache.sh $variantDir $variantFileName $outputDir ${scriptDir}FG2_vep 
...
#sbatch FG3_dinucleotide_properties/1_get_dinuc_properties.sh $variantDir $variantFileName $outputDir ${scriptDir}FG3_dinucleotide_properties

# FG4: Get dna shapes
#sbatch FG4_dna_shape/1_get_dna_shape.sh  $variantDir $variantFileName $outputDir ${scriptDir}FG4_dna_shape

# FG5: Get gc & CpG 
#sbatch FG5_gc_CpG/1_get_gc_CpG.sh $variantDir $variantFileName $outputDir ${scriptDir}FG5_gc_CpG
