...
cd FG2_vep
#./1_download_vep.sh ${scriptDir}FG2_vep
#./2_query_vep.sh $variantDir $variantFileName $outputDir 
#./3_reformat_vep_res.sh $variantDir $variantFileName $outputDir

# FG3: Get dinucleotide properties - DONE
cd FG3_dinucleotide_properties
#./1_get_dinuc_properties.sh $variantDir $variantFileName $outputDir

# FG4: Get dna shapes -DONE
cd FG4_dna_shape
#./1_get_dna_shape.sh  $variantDir $variantFileName $outputDir

# FG5: Get gc & CpG - DONE
cd FG5_gc_CpG
#./1_get_gc_CpG.sh $variantDir $variantFileName $outputDir

# FG6: Get kernels - DONE
cd FG6_kernel
#./1_get_kernel.sh $variantDir $variantFileName $outputDir

# FG7: Get aa substitution matrices - DONE
cd FG7_aa_substitution_matrices
#./1_get_aa_matrices.sh $outputDir

# FG8: Get amino acid properties - DONE
cd FG8_aa_properties
#./1_get_aa_properties.sh $outputDir 

# FG9: Get encode values 
cd FG9_encode
./11_getENCODEdatasets.sh $variantDir $variantFileName $outputDir
...
#./get_alpha_fold_scores_struct_conform.sh $outputDir $variantFileName
#./get_alpha_fold_scores_atom.sh $outputDir $variantFileName
